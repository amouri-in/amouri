...
function App() {
  const data = {
    hero:{
      appType: 'Clothes Shopping',
      tagLine: 'Be it a creator or a fashionista unlock your style and be Amour',
      description: 'Lets get the party started',
      mainActionText: 'About us',
      extraActionText: 'Contact us',
    },
    step1: {
  ...
  return (
    ...
    <div className="box-border">
      <div className="flex flex-col">
        ...
        <div id="faq" className="pt-20 mb-20 text-3xl font-semibold text-center text-blue-800 lg:font-bold">How the site works </div>
